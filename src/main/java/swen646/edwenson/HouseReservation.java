...
public class HouseReservation extends Reservation {
    ...
    public HouseReservation(String accNum, String resvNum, String physicalAddr, String mailingAddr, Date checkInDate, Integer lengthOfStay, Integer bedQty, Integer bedroomQty, Integer bathQty, Integer sqFeet, Double price, String status, Integer floorQty) {
